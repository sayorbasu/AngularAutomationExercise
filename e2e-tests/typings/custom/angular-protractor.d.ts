// Type definitions for Angular Protractor 2.2.0
// Project: https://github.com/angular/protractor
// Definitions by: William and Bill Armstrong <https://github.com/BillArmstrong>
// Forked from: https://github.com/borisyankov/DefinitelyTyped
...
declare module protractor {
    ...
    module ExpectedConditions {
        ...
        */
        function not(...promise: any[]): webdriver.until.Condition<boolean>;
        ...
        */
        function and(...promise: any[]): webdriver.until.Condition<boolean>;
        ...
        */
        function or(...promise: any[]): webdriver.until.Condition<boolean>;

        /**
        * Expect an alert to be present.
        */
        function alertIsPresent(): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking an element is visible and enabled such that you can click it.
        */
        function elementToBeClickable(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking if the given text is present in the element.
        */
        function textToBePresentInElement(frame: string): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking if the given text is present in the element’s value.
        */
        function textToBePresentInElementValue(frame: string): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking that the title contains a case-sensitive substring.
        */
        function titleContains(frame: string): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking the title of a page.
        */
        function titleIs(frame: string): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking that an element is present on the DOM of a page.
        */
        function presenceOf(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking that an element is not attached to the DOM of a page.
        */
        function stalenessOf(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking that an element is present on the DOM of a page and visible.
        */
        function visibilityOf(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking that an element is either invisible or not present on the DOM.
        */
        function invisibilityOf(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;

        /**
        * An expectation for checking the selection is selected.
        */
        function elementToBeSelected(frame: protractor.ElementFinder): webdriver.until.Condition<boolean>;
